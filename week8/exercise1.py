...
def dictionary_please() -> dict:
    ...
    dictionary = {"hello": "hello", "welcome": "hey", "name": "trisha"}
    return dictionary
...
def n_counter(search_for_this, input_list=[1, 4, 3, 5, 7, 1, 3, 2, 3, 3, 5, 3, 7]):
    ...
    Return an integer.
    """
    n_count = input_list.count(search_for_this)
    return n_count
...
def fizz_buzz():
    ...
    fizzBuzzList = []
    for i in range(1, 101): #not 100 lol
        if i%3==0 and i%5==0:
...
def put_behind_bars(input_string="very naughty boy"):
    ...
    """
    #input_string is very naughty boy 
    new_string = '|'.join(input_string)
    newer_string = '|' + new_string + '|'
    return newer_string
...
def best_letter_for_pets():
    ...
    for letter_pet in range(len(the_alphabet)): #len of alphabet
